...
class Model(BaseModel):
    def __init__(self, history, data, disease, all, aug):
        ...
        # Final layer
        output = Conv2D(1, kernel_size=(1, 1), activation="sigmoid")(u1)
